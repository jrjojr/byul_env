...
#include "internal/map.h"     // map_t 정의 필요
...
/**
 * @brief start → goal 직선 방향으로, 반경 range 안의 장애물을 광선처럼 제거합니다.
 ...
 * @return 제거된 장애물 수
 */
BYUL_API int route_carve_beam(map_t* map, 
 ...
 * @return 제거된 장애물 수
 */
BYUL_API int route_carve_bomb(map_t* map, const coord_t* center, int range);
