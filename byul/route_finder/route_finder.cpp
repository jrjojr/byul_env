...
route_finder_t* route_finder_new_full(map_t* map, 
...
route_finder_t* route_finder_new(map_t* map) {
    coord_t start;
    start.x = 0;
    start.y = 0;
    return route_finder_new_full(map, ROUTE_FINDER_ASTAR, &start, &start, 
