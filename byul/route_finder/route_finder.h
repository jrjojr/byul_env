 ...
 */
BYUL_API route_finder_t* route_finder_new(map_t* map);

BYUL_API route_finder_t* route_finder_new_full(map_t* map, 
    route_finder_type_t type, 
 ...
 * @brief 설정값 세터/게터
 */
BYUL_API void route_finder_set_map(route_finder_t* a, map_t* map);
...
BYUL_API map_t* route_finder_get_map(const route_finder_t* a);
