 ...
 */
BYUL_API void projectile_copy(projectile_t* out, const projectile_t* src);
 ...
 */
BYUL_API void shell_copy(shell_t* out, const shell_t* src);
 ...
 */
BYUL_API void missile_copy(missile_t* out, const missile_t* src);
 ...
 * @note 사용 후 반드시 projectile_result_destroy()로 해제해야 합니다.
 */
BYUL_API projectile_result_t* projectile_result_clone(
 ...
 */
BYUL_API void projectile_predictor_copy(projectile_predictor_t* out,
 ...
 * @param[in] src 원본 predictor
 */
BYUL_API void missile_predictor_copy(missile_predictor_t* out,
