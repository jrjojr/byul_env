...
TEST_CASE("test_dstar_lite_blocked_route_refind_ub2") {
    ...
    navgrid_unblock_coord(dsl->m, c2->x, c2->y);
...
TEST_CASE("test_dstar_lite_blocked_route_refind_ub3") {
    ...
    for (int y = 1; y < 10; y++) navgrid_block_coord(dsl->m, 5, y);    
    ...
    navgrid_block_coord(dsl->m, c0->x, c0->y);
    navgrid_unblock_coord(dsl->m, c3->x, c3->y);
...
TEST_CASE("test_dstar_lite_blocked_route_refind_ub4") {
    ...
    navgrid_block_coord(dsl->m, c0->x, c0->y);
    navgrid_unblock_coord(dsl->m, c4->x, c4->y);
...
TEST_CASE("test_dstar_lite_blocked_route_refind_ub5") {
    ...
    navgrid_block_coord(dsl->m, c0->x, c0->y);
    navgrid_unblock_coord(dsl->m, c5->x, c5->y);
...
for (int i = 0; i < 5; i++) {
    ...
    navgrid_block_coord(dsl->m, coord_get_x(coord_i), coord_get_y(coord_i));
...
TEST_CASE("test_dstar_lite_block_all_around_start") {
    ...
    navgrid_t* m = navgrid_new_full(0, 0, NAVGRID_DIR_8, is_coord_blocked_navgrid);
    dstar_lite_t* dsl = dstar_lite_new_full(m, start,
        dstar_lite_cost, dstar_lite_heuristic, true);
...
TEST_CASE("test_dstar_lite_find_proto") {
    ...
    // navgrid_t* m = navgrid_new_full(0, 0, NAVGRID_DIR_8);
    navgrid_t* m = navgrid_new();
    dstar_lite_t* dsl = dstar_lite_new_full(m, start,
        dstar_lite_cost, dstar_lite_heuristic, true);
...
TEST_CASE("test_dstar_lite_find_proto_minus_start_plus_goal") {
    ...
    // navgrid_t* m = navgrid_new_full(30, 30, NAVGRID_DIR_8);
    navgrid_t* m = navgrid_new();
    dstar_lite_t* dsl = dstar_lite_new_full(m, start,
        dstar_lite_cost, dstar_lite_heuristic, true);
