...
function(byul_add_help_target)
    set(BYUL_HELP_COMMANDS
        ...
        COMMAND ${CMAKE_COMMAND} -E echo ""
        COMMAND ${CMAKE_COMMAND} -E echo "Default shared-library names (selected by target OS and toolchain):"
        COMMAND ${CMAKE_COMMAND} -E echo "  Windows + MSVC  : bin/byul.dll + lib/byul/byul.lib"
        COMMAND ${CMAKE_COMMAND} -E echo "  Windows + MinGW : bin/libbyul.dll + lib/byul/libbyul.dll.a"
        COMMAND ${CMAKE_COMMAND} -E echo "  Linux native    : lib/libbyul.so"
        COMMAND ${CMAKE_COMMAND} -E echo "  Ubuntu + MinGW cross targets Windows, so it produces libbyul.dll, not libbyul.so."
        COMMAND ${CMAKE_COMMAND} -E echo "  The target CMAKE_SYSTEM_NAME, not the host OS, determines the DLL/SO suffix."
        COMMAND ${CMAKE_COMMAND} -E echo ""
        ...
        COMMAND ${CMAKE_COMMAND} -E echo ""
        COMMAND ${CMAKE_COMMAND} -E echo "Header and ABI audit (Python 3.10+):"
        COMMAND ${CMAKE_COMMAND} -E echo "  PYTHON tools/header_abi_audit.py"
        COMMAND ${CMAKE_COMMAND} -E echo "  Add --strict-header byul/PATH/HEADER.h for a touched public header."
        COMMAND ${CMAKE_COMMAND} -E echo "  Add --c-compiler C_COMPILER --cxx-compiler CXX_COMPILER for the C17/C++17 standalone matrix."
        COMMAND ${CMAKE_COMMAND} -E echo ""
