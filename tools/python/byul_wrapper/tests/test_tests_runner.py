...
class TestsRunnerTest(unittest.TestCase):
    ...
    def test_unit_only_unittest_builds_one_discovery_per_file(self):
        ...
        self.assertIn("test_coord_list_abi_policy.py", commands[4])
        self.assertIn("test_navcell_abi_policy.py", commands[5])
        self.assertIn("test_navsys_abi_vocabulary.py", commands[6])
        self.assertIn("test_tests_runner.py", commands[7])
        self.assertIn("test_wrapper_coverage.py", commands[8])
