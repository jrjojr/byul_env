...
#ifndef UNIT_PREFIX_HPP
#define UNIT_PREFIX_HPP
...
public:
    Progress(unsigned int tTotalCount=10000,
        ...
        std::string tName="unit_prefix_progress",
        char tFigure = '#'
        ){
            mName = tName;
...
struct Stopwatch{
    Stopwatch(std::string tName="unit_prefix_stopwatch"){
...
struct Logger{
    Logger(std::string tName="unit_prefix_logger") : 
        test_log(tName+".log"){
